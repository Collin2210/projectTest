...
public class StaticShader extends ShaderProgram3D {
    ...
    private static final String VERTEX_FILE = "src/Visuals/shaders/vertexShader.vert";
    private static final String FRAGMENT_FILE = "src/Visuals/shaders/fragmentShader.frag";
